...
Supervision Automatisée : Intégration d'Actuator pour monitorer l'état de santé de l'API et de la base de données (/actuator/health), prêt à être intégré à un écosystème d'observabilité (type Prometheus/Grafana).
